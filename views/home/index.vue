    ...
    <el-col :span="8" style="margin-top: 20px">
      <el-card shadow="hover">
        ...
        <div class="login-info">
          <p>上次登录时间：<span>2022-05-04</span></p>
  ...
  mounted() {
    getData().then((res) => {
      ...
      if (code === 20000) {
        ...
        const legend1 = {data: keyArray}
        const legend2 = {textStyle: {color: "#333"}}
        // const option = {
        //   xAxis: {
        //     data: xData,
        //   },
        ...
        this.echartData.order.legend = legend1
        ...
        this.echartData.user.series = [
          ...
          this.echartData.user.legend = legend2
